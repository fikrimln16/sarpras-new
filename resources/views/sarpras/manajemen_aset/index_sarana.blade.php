                ...
                <tbody>
                    @foreach ($penempatanSarana as $penempatan)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('manajemen_aset.sarana', ['id' => $penempatan->id]) }}"
                                ...
                                @if (auth()->user()->role == '2')
                                    <button type="button" class="btn btn-warning" data-bs-toggle="modal"
                                        ...
                                        data-penggunaan="{{ $penempatan->penggunaan }}"
                                        data-kondisi="{{ $penempatan->kondisi }}" data-status="{{ $penempatan->status }}"
                                        data-nilai-perolehan="{{ $penempatan->nilai_perolehan }}">
                                        Edit
                                    </button>
