           ...
           <form id="editForm" method="POST" action="{{ route('manajemen_aset.sarana.update') }}">
               ...
               <div class="modal-body">
                   ...
                   <div class="mb-3">
                       ...
                       <input type="text" class="form-control" id="edit-nama-sarana" name="nama_sarana"
                           disabled>
                   </div>
                   <div class="mb-3">
...
<script>
   document.addEventListener('DOMContentLoaded', function() {
            ...
            editModal.addEventListener('show.bs.modal', function(event) {
                ...
                var nilaiPerolehan = button.getAttribute('data-nilai-perolehan');
                ...
                nilaiPerolehanInput.value = nilaiPerolehan;
            });
        });
</script>