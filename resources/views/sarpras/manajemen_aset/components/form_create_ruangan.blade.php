                ...
                <form id="ruanganForm" action="{{ route('manajemen_aset.ruangan.create') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-control" id="bangunan" name="id_prasarana">
                            ...
                            <option value="{{ $b->id }}">{{ $b->NM_BRG_TANAH }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="kelompok_ruangan" name="kelompok_ruangan" required>
                    </div>
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label for="tgl_mulai_kontrak" class="form-label">Tanggal Mulai Kontrak:</label>
                            <input type="date" class="form-control" id="tgl_mulai_kontrak" name="tgl_mulai_kontrak" required>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="tgl_selesai_kontrak" class="form-label">Tanggal Selesai Kontrak:</label>
                            <input type="date" class="form-control" id="tgl_selesai_kontrak" name="tgl_selesai_kontrak">
                        </div>
                    </div>
